...
public class ChatFrame {
    ...
    private DefaultListModel<String> modle = new DefaultListModel<>();// 用户列表模型
    private JList<String> list = new JList<>(modle);// 用户列表
    ...
    ChatFrame(ClientService service, String uname) {
        this.isRun = true;
        this.uname = uname;
                ...
                if (msg != null) {
                    ...
                    if (msg.contains("[") && msg.lastIndexOf("]") != -1) {
                        ...
                        for (String userName : userNames) {
                            modle.addElement(userName.trim());
                        }
                    } else {
                        //将聊天数据设置到聊天消息显示区
